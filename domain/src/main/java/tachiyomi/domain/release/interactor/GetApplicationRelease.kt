...
class GetApplicationRelease(
    ...
    suspend fun await(arguments: Arguments): Result {
        ...
        val release = service.latest(
            repository = arguments.repository,
            releaseTagPrefix = arguments.releaseTagPrefix,
