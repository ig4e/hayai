...
class FilterHandler {
    ...
    fun getQueryMap(filters: FilterList): Map<String, Any> {
        ...
        val contentRatingList = mutableListOf<String>()
        val demographicList = mutableListOf<String>()
        val statusList = mutableListOf<String>()
        val includeTagList = mutableListOf<String>()
        val excludeTagList = mutableListOf<String>()
