...
/**
 * Modern chip-style tabs for library categories
 */
@Composable
fun LibraryCategoryTabs(
    ...
    LaunchedEffect(currentPageIndex) {
        listState.animateScrollToItem(currentPageIndex.coerceAtMost(categories.lastIndex))
    }
        ...
        LazyRow(
            ...
            itemsIndexed(categories) { index, category ->
                CategoryChip(
                    ...
                    count = getNumberOfMangaForCategory(category),
