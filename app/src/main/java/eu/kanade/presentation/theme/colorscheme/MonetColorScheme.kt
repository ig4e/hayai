...
private class MonetCompatColorScheme(seed: Color) : BaseColorScheme() {
    ...
    companion object {
        private fun generateColorSchemeFromSeed(seed: Color, dark: Boolean): ColorScheme {
